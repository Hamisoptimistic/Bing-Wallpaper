...
- 🔔 **Optional Minimize to Tray**: Enable the Windows 11-style **Keep in tray** toggle beside Download to hide the window when closed and restore it from the notification area.
